...
#include "cv_plane/serverSaveDetectionResult.h"
...
class CvDetection {
    ...
    public:
        ...
        bool saveServerClient(cv_plane::serverSaveDetectionResult::Request&req,cv_plane::serverSaveDetectionResult::Response &res);
