...
#include <chrono>
#include "time.h"
#include "cv_plane/object.h"
#include "cv_plane/multiobjects.h"
#include "cv_plane/BoundingBox.h"
#include "cv_plane/BoundingBoxes.h"
#include "cv_plane/serverSavePlaneResult.h"
...
class CvDetection {
    ...
    public:
        ...
        bool saveServerClient(cv_plane::serverSavePlaneResult::Request&req,cv_plane::serverSavePlaneResult::Response &res);
    ...
    private:
        ...
        ros::ServiceServer plane_service;
