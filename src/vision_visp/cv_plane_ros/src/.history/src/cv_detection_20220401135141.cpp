...
void CvDetection::infer(cv::Mat &img)
{
    ...
    // Set the frame ID and timestamp.  See the TF tutorials for information on these.
        ...
        p1.x = temp.center_point_[0];
        p1.y = temp.center_point_[1];
        p1.z = temp.center_point_[2];
        p2.x = temp.target_point_[0];
        p2.y = temp.target_point_[1];
        p2.z = temp.target_point_[2];
