...
std::array<int, 3> Position_Transform::Get_ROBOT_XYZ() {
    ...
    std::array<int, 3> world_frame_pos_3x1 = (cv::Mat_<float>(3, 1) << gripper_frame_pos_4x1.at<float>(0, 0),
								   gripper_frame_pos_4x1.at<float>(0, 1),
								   gripper_frame_pos_4x1.at<float>(0, 2));
