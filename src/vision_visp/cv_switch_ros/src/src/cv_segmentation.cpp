...
cv::Mat CvSegmentation::image_to_tensor(const cv::Mat& image, shared_ptr<TRT::Tensor>& tensor, int ibatch){
...
tuple<cv::Mat, cv::Mat> CvSegmentation::post_process(shared_ptr<TRT::Tensor>& tensor, int ibatch){
...
void CvSegmentation::render(cv::Mat& image, const cv::Mat& prob, const cv::Mat& iclass){
...
cv::Mat CvSegmentation::inference(cv::Mat& image){
...
void CvSegmentation::getEngine(const string& model_file){
