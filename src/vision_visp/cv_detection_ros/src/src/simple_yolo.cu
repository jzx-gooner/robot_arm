...
namespace SimpleYolo{
    ...
    */
    ...
    void MixMemory::reference_data(void* cpu, size_t cpu_size, void* gpu, size_t gpu_size){
        ...
        /* 可以允许MixMemory引用一块内存，不属于自己管理，但是可以引用 */
    ...
    */
    ...
    public:
        ...
        bool build_model(const void* pdata, size_t size) {
            ...
            if(stream_ == nullptr)
                return false;
            //标准的tensorrt的反序列话流程，runtime-engine-context那一套
    ...
    */
    ...
    public:
        ...
        virtual void worker(promise<bool>& result) override{
            ...
            gpu_               = gpuid;
            //执行下面的代码，会使得主线程继续执行， 在这里设置阻塞的原因，可能设计者任务初始化会慢于任务的到来
