...
std::array<int, 3> Position_Transform::Get_XYZ() {
    ...
    cout<<"distance : " << Depthmat.at<uint16_t>(Depth_Pix.at(0),Depth_Pix.at(1))<<endl;
    float distance = Depthmat.at<uint16_t>(Depth_Pix.at(1),Depth_Pix.at(0))
    Image_Pix=Depth_inner.inverse()*Image_Pix*distance;
